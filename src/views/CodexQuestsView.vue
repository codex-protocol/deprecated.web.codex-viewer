<template>
  <div>
    ...
    <div class="content">
      ...
      <div class="schedule">
        <h2>June 25th - Contest</h2>
        <p>
          Share the "Digital Assembly" edition you claimed from your collection on social media for a chance to win CODX at our Token Generation Event (be sure to make your Codex Record public before sharing!).
        </p>

        <h2>June 27th - Transfers</h2>
        <p>
